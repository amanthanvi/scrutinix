...
> 2. `git diff --stat 76c4698..HEAD -- app/api/analyze/route.ts lib/server/analyze.ts hooks/use-scan-stream.ts tests/integration/analyze-routes.test.ts lib/domain/types.ts`
