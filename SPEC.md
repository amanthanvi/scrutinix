...
- Toolchain decision: the current implementation targets `next@16.2.12`, `react@19.2.8`, and Node `22.x` for engines and CI so Vercel stays on the Node 22 major line without auto-upgrading to a future major.
